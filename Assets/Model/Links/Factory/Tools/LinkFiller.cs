...
namespace Links
{
    namespace FactoryTools
    {
        public class LinkFiller
        {
            ...
            public void FillLayer(IReadOnlyList<LinkMap> maps, int numberLayer, TypesPoints filler)
            {
            ...
            public void FillSpace(IReadOnlyList<LinkMap> maps, int numberLayer, TypesPoints filler)
            {
                for (int i = 0; i < Size; i++)
                {
                    for (int j = 0; j < Size; j++)
